...
- **src:** ensure deprecated `config` option is still supported by `prettierFormatter` ([e48badf][8]) <sup>closes [#139][9]</sup>
...
- **pluginnameinference:** remove the inference. Default to "unknown plugin" ([#78][45]) ([91c22ec][46]) <sup>closes [#60][47]</sup>
...
- Upgrade to babel 7 ([#37][103]) ([a174a76][104]) <sup>closes [#23][105]</sup>
...
- **release:** manually release a major version ([c78460b][148]) <sup>closes [#11][149]</sup>
